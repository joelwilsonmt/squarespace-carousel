...
export const Carousel: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="efm-relative efm-w-full efm-h-[600px] efm-flex efm-items-center efm-justify-center efm-bg-background">
  ...
  if (error || images.length === 0) {
    return (
      <div className="efm-relative efm-w-full efm-h-[600px] efm-flex efm-items-center efm-justify-center efm-bg-background efm-text-gray-500">
  ...
  return (
    <div className="efm-relative efm-w-full efm-h-[600px] efm-overflow-hidden efm-bg-background efm-flex efm-flex-col">
      {/* Main Image Area */}
