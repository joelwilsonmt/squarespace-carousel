    ...
    <div className="efm-max-w-7xl efm-mx-auto efm-px-4 efm-py-12">
      <div className="efm-grid efm-grid-cols-1 md:efm-grid-cols-2 lg:efm-grid-cols-3 efm-gap-8">
        {endorsements.map((endorser, index) => (
          <div
            key={index}
            className="efm-bg-transparent efm-border efm-border-gray-200 efm-p-3 efm-shadow-sm efm-transition-all efm-duration-300 hover:efm-shadow-lg hover:efm-transform hover:efm-translate-y-[-4px] efm-border-l-4 efm-border-l-primary"
          >
